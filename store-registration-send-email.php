...
$link = "'127.0.0.1:8080/verify-email.php?key=".$_POST['email']."&token=".$token."'>Click and Verify Email";
...
$mail->SMTPAuth = true;                  
// GMAIL username
$mail->Username = "foughaliwejden2000@gmail.com";
// GMAIL password
$mail->Password = "dadoucha@7";
$mail->SMTPSecure = "ssl";  
